<template>
    <div>
        ...
        <PrizeListPage v-if="sysStatus === 2 || sysStatus === 5" :data="sysStatusRes.started_2_5" :hideEmployeeInfo="hideEmployeeInfo" :notary="notary" />
...
onMounted(async () => {
    ...
    notary.value = sysStatusRes.value.notary;
